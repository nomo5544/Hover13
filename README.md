...
* Відбувається пошук тексту вірша. Ми обговорювали два варіанти: звернення до **зовнішнього API** (наприклад, `getbible.net`) або використання **локального JSON-файлу** (`bibleText.json`) з усіма текстами Біблії для миттєвої роботи офлайн.
