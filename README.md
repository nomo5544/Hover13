...
* **Відображення на новій сторінці:** Результат обробки має відкриватися в новій вкладці браузера, де текст виглядає як документ google.
...
2. Натискає на іконку розширення.
...
* Програма зчитує значення.
* Відбувається пошук тексту вірша з використанням **локального JSON-файлу** (`bibleText.json`) з усіма текстами Біблії для миттєвої роботи офлайн.
...
* **Коректне позиціонування підказки:** Логіка, яка перевіряє межі екрана, щоб спливаюче вікно не "випадало" за межі видимої зони браузера.
